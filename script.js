const userdetails = [
  ...
  function page(num) {
    ...
    tableheadrow.append(id, name, email)
    ...
    for (i = (num - 1) * 10; i < num * 10; i++) {
      ...
      sno.innerHTML = userdetails[i].id
      ...
      pagenumber.innerHTML=`Page: `;
        ...
        let pagenumber = document.getElementById('pagenumber')
        pagenumber.innerHTML=`Page: ${num}`;
      }
      
      tablebodyrow.append(sno, name, email)
      tablebody.append(tablebodyrow)
    }
  
    table.append(tablehead, tablebody)
    userdata.append(table)
    localStorage.setItem('pageno', num)
  }
